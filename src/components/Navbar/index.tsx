...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 w-full md:w-[150px] bg-white border-t border-gray-300  h-20 md:h-full flex items-center md:flex-col justify-around md:justify-evenly md:-z-10">
      <Link
        to="replies"
